    ...
    public class RabbitMQPaymentConsumer : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (chanel, evt) =>
            {
                ...
                var vo = JsonSerializer.Deserialize<PaymentoMessage>(content);
        ...
        private async Task ProcessPayment(PaymentoMessage vo)
        {
            var result = _processPayment.PaumentProcessor(); //mockado
